...
int main(int argc, char* argv[])
{
  ...
  if (argc != 3) 
   ...
   allocation_tableau(traitementBTemp, OCTET, nTaille);
    ...
    dilatation(tabIdR, traitementRTemp, nH, nW);
    erosion(traitementRTemp, traitementR, nH, nW);

    dilatation(tabIdG, traitementGTemp, nH, nW);
    erosion(traitementGTemp, traitementG, nH, nW);

    dilatation(tabIdB, traitementBTemp, nH, nW);
    erosion(traitementBTemp, traitementB, nH, nW);
